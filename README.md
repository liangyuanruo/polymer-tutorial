...
### Tutorial
This code is from following this Polymer  [tutorial](https://auth0.com/blog/build-your-first-app-with-polymer-and-web-components/), which builds a Progressive Web App to serve Chuck Norris quotes.

The rest of this readme is generated by the default Polymer-CLI.

# Polymer App Toolbox - Starter Kit[![Build Status](https://travis-ci.org/Polymer/polymer-starter-kit.svg?branch=master)](https://travis-ci.org/Polymer/polymer-starter-kit)
